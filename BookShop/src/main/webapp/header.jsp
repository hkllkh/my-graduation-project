    ...
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
                ...
                <h1 class="navbar-brand"><a href="index.action"> 毕设书城</a></h1>
            </div>
            <!--navbar-header-->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle <c:if test="${param.flag==2}">active</c:if>" data-toggle="dropdown">价格索引<b class="caret"></b></a>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <ul class="multi-column-dropdown">
                                            ...
                                            <li><a class="list" href="booktypes_list.action?pageNumber=1&btid=-1">全部显示</a></li>
        ...
        <div class="header-info">
            <div class="header-right search-box">
       		...
       		<div class="header-right cart">
                <a href="book_cart2.jsp">
                    <span class="glyphicon glyphicon-folder-close <c:if test="${param.flag==8 }">active</c:if>" aria-hidden="true"><span class="card_num"><c:choose><c:when test="${empty order}">0</c:when><c:otherwise></c:otherwise></c:choose></span></span>
                </a>
            </div>
            ...
            <div class="header-right cart">
                <a href="book_cart.jsp">
                    <span class="glyphicon glyphicon-shopping-cart <c:if test="${param.flag==8 }">active</c:if>" aria-hidden="true"><span class="card_num"><c:choose><c:when test="${empty order}">0</c:when><c:otherwise></c:otherwise></c:choose></span></span>
